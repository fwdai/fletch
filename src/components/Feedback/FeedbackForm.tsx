  ...
  return (
    <ModalBody>
      <div className="modal-field">
        <label className="modal-label text-sm" htmlFor="fb-message">
          What’s on your mind?
        </label>
        <TextArea
          id="fb-message"
      ...
      <div className="modal-field">
        <label className="modal-label text-sm" htmlFor="fb-email">
          Your email <span className="modal-opt">optional, so we can reply</span>
        </label>
        <TextInput
          id="fb-email"
          type="email"
      ...
      {status === "error" && (
        <div className="modal-error text-sm">
          <div className="fb-error-t">Couldn’t send that.</div>
          <div>{error}</div>
          <Button variant="link" size="sm" onClick={state.emailInstead}>
