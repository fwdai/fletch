...
const EXPERIMENTS: FeatureItem[] = [
  {
    ...
    sub: "Adds a Custom / Native switch per agent to use the provider's own terminal UI. Fidelity varies.",
  },
];
  ...
  return (
    <div className="set-pane">
      <SetHead
        ...
        title="Experimental"
        desc="Early features we're still polishing. Toggle them on to try them, off to go back."
      />
